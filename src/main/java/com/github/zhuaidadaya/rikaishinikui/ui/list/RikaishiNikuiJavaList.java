...
import com.github.zhuaidadaya.rikaishinikui.handler.java.version.JavaVersion;
...
public class RikaishiNikuiJavaList extends JList<JavaVersion> implements RikaishiNikuiComponent {
    private int width = 0;
    ...
    public void setListData(Collection<JavaVersion> data) {
        this.data = data;
        String area = config.getConfigString("area");
        int selected = getSelectedIndex();
        Vector<? extends JavaVersion> vector = new Vector<>(data);
